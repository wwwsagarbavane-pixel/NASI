...
import { Award, CheckCircle2, ChevronDown, ChevronUp, Sparkles, Check } from 'lucide-react';
...
export const Step5Sponsorship: React.FC<Step5Props> = ({
  sponsorship,
  tradingTable,
  onChange,
}) => {
    ...
    <div className="space-y-6 step-enter">
      <div>
        ...
        <p className="text-sm sm:text-base text-slate-500 mt-1.5 font-normal">
          Would you like to become an ISC 2026 Sponsor?
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            <h3 className="font-bold text-slate-900 text-base">No, Skip Sponsorship</h3>
            <p className="text-xs text-slate-500 mt-0.5">
              I do not wish to sponsor the event.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Includes delegate passes, stalls, presentation slots, and branding.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4 step-enter">
          ...
          {hasIncludedTable && (
            <div className="p-4 rounded-xl bg-blue-50 border border-blue-200 text-blue-900 text-xs space-y-2">
              ...
              <p>
                Your <strong>{selectedSponsor.name}</strong> includes <strong>1 Trading Table</strong>.
              </p>
              <div className="flex items-center gap-2 pt-1">
                ...
                >
                  ✓ Use Included Table (Save ₹30,000)
                </button>
                <button
                  type="button"
