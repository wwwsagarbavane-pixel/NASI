...
export const Step6Advertisement: React.FC<Step6Props> = ({
  advertisement,
  sponsorship,
  onChange,
}) => {
    ...
    <div className="space-y-6 step-enter">
      <div>
        ...
        <p className="text-sm sm:text-base text-slate-500 mt-1.5 font-normal">
          Would you like to book an advertisement in the Congress Souvenir?
        </p>
      </div>
          ...
          {sponsorHasAd && (
            <div className="p-4 rounded-xl bg-purple-50 border border-purple-200 text-purple-900 text-xs space-y-2">
              <div className="flex items-center gap-2 font-bold">
                ...
                <span>Your Sponsorship Includes</span>
              </div>
              <p>
                ✓ {selectedSponsor?.includesAd === 'back_cover' ? 'Back Cover Advertisement' : selectedSponsor?.includesAd === 'full_page' ? 'Full Page Advertisement' : 'Half Page Advertisement'} included with <strong>{selectedSponsor?.name}</strong>.
              </p>
              <div className="flex items-center gap-2 pt-1">
                ...
                >
                  Choose Another Placement Below
                </button>
              </div>
            </div>
          )}
