...
export const Step3TradingTable: React.FC<Step3Props> = ({ tradingTable, onChange }) => {
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-card p-5 sm:p-7 space-y-6 step-enter">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <h3 className="font-bold text-slate-900 text-base flex items-center gap-2">
              ...
              <span>Trading Table Booking</span>
            </h3>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Tables will be allocated in the central B2B meeting zone.
              </p>
            </div>
